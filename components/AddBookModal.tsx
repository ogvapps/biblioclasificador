  ...
  const processImage = async (base64: string, imgSrc: string) => {
    ...
    try {
      ...
      try {
        ...
        imageToSend = compressedDataUrl.split(',')[1];
              ...
              <div className="flex-1 flex flex-col relative animate-in fade-in slide-in-from-left-4 duration-300">
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-2">
                  <button
                    ...
                    className="flex-1 py-3 px-4 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-700 shadow-md shadow-indigo-200 flex items-center justify-center gap-2 text-sm"
                    disabled={loading}
                  >
                    <Camera className="w-5 h-5" />
                  ...
                  <button
                    ...
                    className="flex-1 py-3 px-4 bg-slate-100 text-slate-700 border border-slate-200 rounded-xl font-bold hover:bg-slate-200 flex items-center justify-center gap-2 text-sm"
                    disabled={loading}
                  >
